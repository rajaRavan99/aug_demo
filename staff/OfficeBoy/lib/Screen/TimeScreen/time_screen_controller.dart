...
class TimeScreenController extends GetxController {
  ...
  RxString formatWithMonthName = DateFormat('dd MMMM, yyyy').format(DateTime.parse(DateTime.now().toString())).obs;
  ...
  // -------------------->  Daily User Time Calculation Function   <----------------------- //
  ...
  Future<void> selectDate(context) async {
    ...
    formatWithMonthName.value = DateFormat('dd MMMM, yyyy').format(DateTime.parse(selectedDate.toString()));
    durationTime.value = '';
    update();
